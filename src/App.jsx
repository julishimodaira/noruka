        ...
        <div style={{padding:"0 18px"}}>
          ...
          {plan && (
            <div style={{marginTop:4}}>
              ...
              <div style={{marginTop:10,padding:"9px 12px",background:"rgba(245,158,11,0.07)",border:"1px solid rgba(245,158,11,0.2)",borderRadius:9}}>
                <div style={{fontSize:10,color:"rgba(255,255,255,0.5)",lineHeight:1.6,textAlign:"center"}}>⚠️ This route was generated by AI and is for guidance only. Always confirm elevator status, platform gaps, and accessibility needs with station staff before and during travel. · JR East English: <strong style={{color:"#7dd3fc"}}>050-2016-1603</strong></div>
              </div>
              <button
      ...
      <div style={{background:"rgba(8,11,20,0.92)",borderBottom:"1px solid rgba(255,255,255,0.06)",padding:"12px 18px",position:"sticky",top:0,zIndex:300,backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)"}}>
        <div style={{maxWidth:900,margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",gap:10}}>
          ...
          <div style={{display:"flex",gap:5,flexShrink:0,alignItems:"center"}}>
            ...
            <div style={{position:"relative",display:"inline-flex"}} onMouseEnter={e=>e.currentTarget.querySelector('.profile-tip').style.opacity=1} onMouseLeave={e=>e.currentTarget.querySelector('.profile-tip').style.opacity=0}>
              ...
              <div className="profile-tip" style={{opacity:0,transition:"opacity 0.2s",position:"absolute",top:"110%",right:0,background:"#1e2535",border:"1px solid rgba(255,255,255,0.1)",borderRadius:8,padding:"6px 10px",fontSize:11,color:"rgba(255,255,255,0.8)",whiteSpace:"nowrap",pointerEvents:"none",zIndex:999}}>My Profile 👤</div>
            </div>
            <div style={{position:"relative",display:"inline-flex"}} onMouseEnter={e=>e.currentTarget.querySelector('.sos-tip').style.opacity=1} onMouseLeave={e=>e.currentTarget.querySelector('.sos-tip').style.opacity=0}>
              ...
              <div className="sos-tip" style={{opacity:0,transition:"opacity 0.2s",position:"absolute",top:"110%",right:0,background:"#1e2535",border:"1px solid rgba(255,255,255,0.1)",borderRadius:8,padding:"6px 10px",fontSize:11,color:"rgba(255,255,255,0.8)",whiteSpace:"nowrap",pointerEvents:"none",zIndex:999}}>Show to staff in emergency 🆘</div>
            </div>
            <div style={{position:"relative",display:"inline-flex"}} onMouseEnter={e=>e.currentTarget.querySelector('.kofi-tip').style.opacity=1} onMouseLeave={e=>e.currentTarget.querySelector('.kofi-tip').style.opacity=0}>
              <a href="https://ko-fi.com/noruka" target="_blank" rel="noopener noreferrer" style={{background:"rgba(255,94,94,0.1)",border:"1px solid rgba(255,94,94,0.22)",borderRadius:9,color:"#ff6b6b",padding:"6px 10px",cursor:"pointer",fontSize:13,textDecoration:"none",display:"inline-flex",alignItems:"center"}}>☕</a>
              <div className="kofi-tip" style={{opacity:0,transition:"opacity 0.2s",position:"absolute",top:"110%",right:0,background:"#1e2535",border:"1px solid rgba(255,255,255,0.1)",borderRadius:8,padding:"6px 10px",fontSize:11,color:"rgba(255,255,255,0.8)",whiteSpace:"nowrap",pointerEvents:"none",zIndex:999}}>Support Noruka on Ko-fi ☕</div>
            </div></div>
        </div>
      </div>
          ...
          <>
            <div style={{textAlign:"center",marginBottom:28,paddingTop:8}}>
              ...
              <div style={{width:"100%",textAlign:"center",marginTop:10}}>
                <span style={{fontSize:11,color:"rgba(255,255,255,0.4)",lineHeight:1.6}}>🎉 Noruka is <strong style={{color:"#7dd3fc"}}>free during beta</strong> — enjoy full access while we continue to grow and improve.</span>
              </div>
